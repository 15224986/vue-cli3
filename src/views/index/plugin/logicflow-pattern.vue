        ...
        methods: {
            initLogicflow() {
                this.logicflowObj = new LogicFlow({
                    ...
                    snapline: true,
                    // 样式配置
                    style: this.logicStyle
                });

                this.logicflowObj.setPatternItems(this.logicflowTools);
                this.logicflowObj.render(this.logicflowData);

                // this.logicflowObj.on('node:add', (data) => {
                //     console.log('node:add', data)
                // })
                this.logicflowObj.on('edge:add', (data) => {
                    console.log('edge:add', data)

                    let sourceNode = this.logicflowObj.getNodeModel(data.data.sourceNodeId)
